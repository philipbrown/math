...
class MathTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @test */
    public function should_set_scale()
    {
        $this->assertInstanceOf('PhilipBrown\Math\PositiveNumber', $this->m()->setScale(2));
    }

    /** @test */
    public function should_throw_exception_on_invalid_number()
    {
        $this->setExpectedException('PhilipBrown\Math\Exceptions\InvalidNumberException');

        $this->m()->create('what up');
    }

    /** @test */
    public function should_throw_exception_on_invalid_scale()
    {
        $this->setExpectedException('PhilipBrown\Math\Exceptions\InvalidNumberException');
    ...
    /** @test */
    public function should_test_add_command()
    {
    ...
    /** @test */
    public function should_test_compare_command()
    {
    ...
    /** @test */
    public function should_test_divide_command()
    {
    ...
    /** @test */
    public function should_test_modulus_command()
    {
    ...
    /** @test */
    public function should_test_multiply_command()
    {
    ...
    /** @test */
    public function should_test_power_command()
    {
    ...
    /** @test */
    public function should_test_square_root_command()
    {
    ...
    /** @test */
    public function should_test_subtract_command()
    {
